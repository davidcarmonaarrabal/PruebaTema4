    ...
    return (
        <section className="min-h-screen max-w-[1024px] mx-auto px-10 py-10">
            ...
            <div className="flex flex-col gap-10 items-center mt-20 p-10 bg-blue-100 rounded-xl">
                ...
                <p className="text-4xl place-self-center text-slate-400">{paciente.localidad}</p>
                <p className="text-2xl place-self-center text-blue-400 *:font-bold">{paciente.fecha_nacimiento}</p>
            </div>
        </section>
    );
}
